    ...
    <nav className="bg-gray-950/80 backdrop-blur-md border-b border-white/5 py-4 md:px-6 fixed w-full z-50 shadow-lg">
        ...
        <div className="text-3xl font-bold text-indigo-400 flex items-center">
          <a href="/" className="flex items-center">
            <img
              ...
              alt="Icon"
            />
            <span className="md:text-4xl ml-2 bg-gradient-to-r from-cyan-400 to-blue-500 bg-clip-text text-transparent drop-shadow-sm hover:scale-105 transition-transform duration-300">Teranis</span>
          </a>
        </div>
      ...
      >
        <ul className="bg-gray-950/95 backdrop-blur-lg w-full flex flex-col space-y-10 text-white py-4 text-xl items-center font-medium md:hidden shadow-[0px_10px_15px_rgba(255,255,255,0.01)] border-b border-white/5">
          ...
          <li className="hover:text-indigo-400 cursor-pointer">
            <Link to="/certificates26" onClick={toggleMenu}>
              CERTIFICATES
            </Link>
          </li>
        </ul>
